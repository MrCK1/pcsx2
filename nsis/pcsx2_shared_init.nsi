...
; Copyright (C) 2019 Christian Kenny
...
# Full installer mode (writes to Program Files)
...
# If the user doesn't have admin rights, disable the button for the full (non-portable) installer
${If} $IsAdmin == 0
EnableWindow $InstallMode_Full 0
${EndIf}

# Create labels/buttons for the full installation
...
# Displays a cute little UAC shield
